  ...
  return (
    <>
      <div data-aos="fade-up" className="flex flex-col gap-4 ">
        <div
          data-aos="fade-up"
          className="bg-gradient-to-r from-[#207064] to-[#139eab] drop-shadow-lg hover:drop-shadow-xl transition-all duration-300 px-[30px]  lg:h-[170px] h-[170px] flex items-center justify-center rounded-[20px]"
        >
          <div
            data-aos="fade-up"
        ...
        <div
          data-aos="fade-up"
          className="bg-gradient-to-r from-[#d39726] to-[#f7f748] drop-shadow-lg hover:drop-shadow-xl transition-all duration-300 px-[30px]  lg:h-[170px] h-[170px] flex items-center justify-center rounded-[20px]"
        >
          <div
            data-aos="fade-up"
            className="flex flex-col items-center justify-center"
