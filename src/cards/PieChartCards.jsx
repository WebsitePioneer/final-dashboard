  ...
  return (
    <>
      <div data-aos="fade-up" className="grid grid-cols-1 gap-4 ">
        <div
          data-aos="fade-up"
          className="bg-gradient-to-r from-[#3073cc] to-[#6935bc] drop-shadow-lg hover:drop-shadow-xl transition-all duration-300 px-[30px]  rounded-[20px] flex items-center justify-center lg:h-[170px] h-[130px]"
        >
          <div
            data-aos="fade-up"
        ...
        <div
          data-aos="fade-up"
          className="bg-gradient-to-r from-[#e46233] to-[#dc637f] drop-shadow-lg hover:drop-shadow-xl transition-all duration-300 px-[30px] lg:h-[170px] h-[130px] flex items-center justify-center rounded-[20px]"
        >
          <div
            data-aos="fade-up"
            className="flex flex-col items-center justify-center"
