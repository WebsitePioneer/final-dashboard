        ...
        <table className='border-separate w-full  '>
            ...
            <tbody>
                {data.map((value,index)=> {
                    return <tr key={index} className='text-white'>
                        <td className={`${index % 2 === 0 ? 'bg-[#2a2c2c] font-[450]' : 'bg-[#606163]'} text-[16px] p-2`}>{value.bucket_id}</td>
                        <td className={`${index % 2 === 0 ? 'bg-[#2a2c2c] font-[450]' : 'bg-[#606163]'} text-[16px] p-2`}>{value.title}</td>
                        <td className={`${index % 2 === 0 ? 'bg-[#2a2c2c] font-[450]' : 'bg-[#606163]'} text-[16px] p-2`}>{value.votes_count_number}</td>
                    </tr>
                })}
