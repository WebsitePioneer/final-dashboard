...
const Dashboard = ({ data }) => {
  ...
  return (
    ...
    >
      <div
        data-aos="fade-up"
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-11 gap-[15px]"
      >
        {/* Pie Charts */}
        <div
          data-aos="fade-up"
          className={`lg:col-span-4 drop-shadow-lg w-full bg-gradient-to-r ${
            data ? "from-[#b03a10] to-[#e6741d]" : "from-[#bd3f12] to-[#fa852b]"
          } rounded-[15px] p-[20px]`}
        >
        ...
        <div
          data-aos="fade-up"
          className={`lg:col-span-5  w-full drop-shadow-lg bg-gradient-to-r  ${
            data
              ? "from-[#136c66] to-[#05c2c2]"
              : "from-[#105752] to-[#099797] "
          } rounded-[15px] p-[20px]`}
        >
        ...
        <div
          ...
          className={`lg:col-span-4 bg-gradient-to-r  ${
            data ? "from-[#425959] to-[#394545]" : "from-[#425959] to-[#394545]"
          } drop-shadow-lg rounded-[15px] p-[20px]`}
        >
        ...
        <div
          data-aos="fade-up"
          className={`lg:col-span-5 drop-shadow-lg bg-gradient-to-r ${
            data ? "from-[#7a5416] to-[#b7873c]" : "from-[#7a5416] to-[#b7873c]"
          } rounded-[15px] p-[20px]`}
        >
        ...
        <div
          data-aos="fade-up"
          className={`lg:col-span-4 bg-gradient-to-r ${
            data ? "from-[#544c12] to-[#6e6416]" : "from-[#91821d] to-[#54631e]"
